...
Um unerwünschte Alarme auszuschließen, soll die Kamera außerdem mit dem Infrarot-Sensor, PIR-Sensor genannt, \todo{Regel für Abkürzungen suchen}kooperieren. \\
...
Jedes Gerät besitzt ein General Purpose Input Output-Board (genannt GPIO-Board).\todo{Abkürzung einpflegen}
